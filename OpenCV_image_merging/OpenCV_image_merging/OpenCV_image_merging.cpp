...
{
    Mat image01 = imread(".\\images\\8.jpg", 1);    //右图
    Mat image02 = imread(".\\images\\7.jpg", 1);    //左图
    if (image01.empty())
    {
        std::cout << "Could not read the image01: " << "1.jpg" << std::endl;
        return 1;
    }
    if (image02.empty())
    {
        std::cout << "Could not read the image02: " << "2.jpg" << std::endl;
        return 1;
    }
    ...
    waitKey(0);*/
    imwrite(".\\images\\first_match.jpg", first_match);
...
/*    imshow("直接经过透视矩阵变换", imageTransform1);
    waitKey(0)*/;
    imwrite(".\\images\\trans1.jpg", imageTransform1);
...
//undisortortion image 
void undisortortion(Mat& image, Mat& cameraMatrix, Mat& distCoeffs)
{
